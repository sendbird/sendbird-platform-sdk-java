...
import org.openapitools.client.model.AddApnsPushConfigurationResponsePushConfigurations;
...
public class AddApnsPushConfigurationResponse {
  ...
  private List<AddApnsPushConfigurationResponsePushConfigurations> pushConfigurations = null;

  public AddApnsPushConfigurationResponse() { 
  }

  public AddApnsPushConfigurationResponse pushConfigurations(List<AddApnsPushConfigurationResponsePushConfigurations> pushConfigurations) {
    
    this.pushConfigurations = pushConfigurations;
    return this;
  }

  public AddApnsPushConfigurationResponse addPushConfigurationsItem(AddApnsPushConfigurationResponsePushConfigurations pushConfigurationsItem) {
    if (this.pushConfigurations == null) {
      this.pushConfigurations = new ArrayList<AddApnsPushConfigurationResponsePushConfigurations>();
    }
  ...
  **/
  ...
  public List<AddApnsPushConfigurationResponsePushConfigurations> getPushConfigurations() {
    return pushConfigurations;
  }


  public void setPushConfigurations(List<AddApnsPushConfigurationResponsePushConfigurations> pushConfigurations) {
    this.pushConfigurations = pushConfigurations;
  }
