 ...
 */
@JsonPropertyOrder({
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_BLOCK_PUSH_FROM_BOTS,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_DO_NOT_DISTURB,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_ENABLE_PUSH_FOR_REPLIES,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_END_HOUR,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_END_MIN,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_PUSH_BLOCKED_BOT_IDS,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_PUSH_SOUND,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_PUSH_TRIGGER_OPTION,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_SNOOZE_ENABLED,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_SNOOZE_END_TS,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_SNOOZE_START_TS,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_START_HOUR,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_START_MIN,
  SendBirdUpdatePushPreferencesRequest.JSON_PROPERTY_TIMEZONE
})
...
public class SendBirdUpdatePushPreferencesRequest {
  ...
  public SendBirdUpdatePushPreferencesRequest() { 
  }

  public SendBirdUpdatePushPreferencesRequest blockPushFromBots(Boolean blockPushFromBots) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest doNotDisturb(Boolean doNotDisturb) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest enablePushForReplies(Boolean enablePushForReplies) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest endHour(Integer endHour) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest endMin(Integer endMin) {
    this.endMin = endMin;
    return this;
  }
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest pushBlockedBotIds(List<String> pushBlockedBotIds) {
    this.pushBlockedBotIds = pushBlockedBotIds;
    return this;
  }

  public SendBirdUpdatePushPreferencesRequest addPushBlockedBotIdsItem(String pushBlockedBotIdsItem) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest pushSound(String pushSound) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest pushTriggerOption(SendBirdSendBirdPushTriggerOption pushTriggerOption) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest snoozeEnabled(Boolean snoozeEnabled) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest snoozeEndTs(Long snoozeEndTs) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest snoozeStartTs(Long snoozeStartTs) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest startHour(Integer startHour) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest startMin(Integer startMin) {
  ...
  **/
  ...
  public SendBirdUpdatePushPreferencesRequest timezone(String timezone) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SendBirdUpdatePushPreferencesRequest updatePushPreferencesRequest = (SendBirdUpdatePushPreferencesRequest) o;
  ...
  public String toString() {
    ...
    sb.append("class SendBirdUpdatePushPreferencesRequest {\n");
