...
import org.openapitools.client.model.AddHmsPushConfigurationResponsePushConfigurations;
...
public class AddHmsPushConfigurationResponse {
  ...
  private List<AddHmsPushConfigurationResponsePushConfigurations> pushConfigurations = null;

  public AddHmsPushConfigurationResponse() { 
  }

  public AddHmsPushConfigurationResponse pushConfigurations(List<AddHmsPushConfigurationResponsePushConfigurations> pushConfigurations) {
    
    this.pushConfigurations = pushConfigurations;
    return this;
  }

  public AddHmsPushConfigurationResponse addPushConfigurationsItem(AddHmsPushConfigurationResponsePushConfigurations pushConfigurationsItem) {
    if (this.pushConfigurations == null) {
      this.pushConfigurations = new ArrayList<AddHmsPushConfigurationResponsePushConfigurations>();
    }
  ...
  **/
  ...
  public List<AddHmsPushConfigurationResponsePushConfigurations> getPushConfigurations() {
    return pushConfigurations;
  }


  public void setPushConfigurations(List<AddHmsPushConfigurationResponsePushConfigurations> pushConfigurations) {
    this.pushConfigurations = pushConfigurations;
  }
