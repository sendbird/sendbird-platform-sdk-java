 ...
 */
@JsonPropertyOrder({
  GcUpdateBanByIdData.JSON_PROPERTY_CHANNEL_URL,
  GcUpdateBanByIdData.JSON_PROPERTY_BANNED_USER_ID,
  GcUpdateBanByIdData.JSON_PROPERTY_SECONDS,
...
public class GcUpdateBanByIdData {
  ...
  **/
  ...
  /**
   * Return true if this gcUpdateBanByIdData object is equal to o.
   */
  @Override
