...
public class ResetPushPreferencesResponse {
  ...
  private List<Long> pushBlockedBotIds = null;
  ...
  **/
  ...
  public ResetPushPreferencesResponse startHour(Long startHour) {
  ...
  **/
  ...
  public ResetPushPreferencesResponse endMin(Long endMin) {
    this.endMin = endMin;
    return this;
  }
  ...
  **/
  ...
  public ResetPushPreferencesResponse pushBlockedBotIds(List<Long> pushBlockedBotIds) {
    this.pushBlockedBotIds = pushBlockedBotIds;
    return this;
  }

  public ResetPushPreferencesResponse addPushBlockedBotIdsItem(Long pushBlockedBotIdsItem) {
  ...
  **/
  ...
  public List<Long> getPushBlockedBotIds() {
    return pushBlockedBotIds;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PUSH_BLOCKED_BOT_IDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPushBlockedBotIds(List<Long> pushBlockedBotIds) {
    this.pushBlockedBotIds = pushBlockedBotIds;
  }


  public ResetPushPreferencesResponse startMin(Long startMin) {
  ...
  **/
  ...
  public ResetPushPreferencesResponse endHour(Long endHour) {
