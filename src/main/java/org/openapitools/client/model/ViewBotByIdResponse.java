...
public class ViewBotByIdResponse {
  ...
  private ViewBotByIdResponseBot bot;
  ...
  public ViewBotByIdResponse bot(ViewBotByIdResponseBot bot) {
    this.bot = bot;
    return this;
  }
  ...
  **/
  ...
  public ViewBotByIdResponseBot getBot() {
    return bot;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BOT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBot(ViewBotByIdResponseBot bot) {
    this.bot = bot;
  }
  ...
  **/
  ...
  public ViewBotByIdResponse channelInvitationPreference(Integer channelInvitationPreference) {
