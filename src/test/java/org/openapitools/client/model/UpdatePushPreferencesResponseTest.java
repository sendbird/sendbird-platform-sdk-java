...
/**
 * Model tests for UpdatePushPreferencesResponse
 */
public class UpdatePushPreferencesResponseTest {
    private final UpdatePushPreferencesResponse model = new UpdatePushPreferencesResponse();
